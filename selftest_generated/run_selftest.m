...
outChunkPressure = run_analysis('chunk', 'BaseDir', baseDir, 'ChunkDim', '2d', ...
    ...
    'SlurmPath', slurmPath, 'dV', dV, 'DoPlot', false);
...
assertArrayApprox(outChunkDensity.value, refChunk.density, 1e-12, ...
    'Derived density should match compute_temp_stress_chunk density.');
