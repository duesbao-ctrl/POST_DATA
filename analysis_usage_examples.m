...
%
% -------------------------------------------------------------
% Extra parameters for taskType='network2d'
% -------------------------------------------------------------
% 'ChunkFile'        : optional explicit .txt file path/name (2D only)
...
%   - 'Dx','Dy'      : cell spacing; inferred from filename/coordinates if omitted
...
% Quick setup
% =============================================================
baseDir = 'C:\Users\Administrator\Desktop\WORKSPACE\codex\POST_DATA\tmp_network2d_realistic_test_v2';
chunkDim = '2d';
