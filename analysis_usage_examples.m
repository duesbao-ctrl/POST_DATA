...
%   Dim, Dx, NcountVar, Range_c_x/y/z, Range_vx/vy/vz, DiameterRange,
%   XVarForMean, MeanNumBins, MeanPowerM/N,
%   DiameterHistBinSize, DiameterEmptyBinMode, DiameterPlotStyle,
%   DiameterFitTypes, HistScale, MakePlots.
%
% -------------------------------------------------------------
...
%   - 'DiameterRange' : optional equivalent-diameter range used by size statistics and plots
%   - 'DiameterHistBinSize' : optional fixed bin width for equivalent-diameter distributions
%   - 'DiameterEmptyBinMode' : 'zero' | 'nan' | 'remove' for empty diameter bins
...
diameterRange = [];
diameterHistBinSize = [];
diameterEmptyBinMode = 'zero'; % 'zero' | 'nan' | 'remove'
...
clusterOptions = {'Dim', 2, ...
                  ...
                  'DiameterEmptyBinMode', diameterEmptyBinMode, ...
